...
class StandardMaterial(ABC):
    """
    Encapsulates the data associated with a standard material with the data of a
    specific element.
    """
    ...
    def _compute_roi_sets(self) -> None:
        ...
        self._other_roi_sets = {
            element: self.create_element_roi_set(element) for element in all_elements
        }
    ...
    def intensities(self, roi: RegionOfInterest) -> dict[XRayTransition, float]:
        """
        Returns the x-ray intensities generated by this standard on the specified
        `RegionOfInterest`.
        """
    ...
    def total_intensity(self, roi: RegionOfInterest) -> float:
        """
        Returns the integrated x-ray intensity generated by this standard on the
        specified `RegionOfInterest`.
        """
