...
class SurfaceIonization:
    """
    Computes the surface ionization correction factor for x-ray generation in electron-excited materials.

    The surface ionization factor accounts for the enhancement of x-ray emission due to backscattered electrons
    ...
    def compute(cls, composition: Composition, shell: AtomicShell, energy: float) -> float:
        """
        Computes the surface ionization correction factor using the default algorithm (Pouchou1991).
