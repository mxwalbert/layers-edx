...
def test_mip_element():
    ...
    assert mip == approx(ToSI.ev(173), rel=0.1)
...
def test_mip_elements_vs_epq():
    ...
    assert compare_results(
        python_results, epq_results["element_mips"], tolerance=0.02
...
def test_mip_sio2_vs_epq():
    ...
    assert compare_results(python_mip_ev, epq_results["sio2_mip"], tolerance=0.03), (
